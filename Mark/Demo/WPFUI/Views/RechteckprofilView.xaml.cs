...
namespace WPFUI.Views
{
    ...
    {
        public static List<RechteckProfil> repo = new List<RechteckProfil>();
        ...
        //private void SaveRechteckProfilList()
        //{
        //     rechteckProfil.Add(new RechteckProfil {
        //     ArtName = teilNr.Text, Material= ((MaterialModel)material.SelectedItem).ToString(),
        //     Länge= double.Parse(länge.Text), Querschnittsfläche = double.Parse(querschnitt.Text), Volumen = double.Parse(volumen.Text),
        //     Gewicht = double.Parse(gewicht.Text), SchwerpunktX=double.Parse(spx.Text), SchwerpunktY= double.Parse(spy.Text),
        //     SchwerpunktZ = double.Parse(spy.Text), FlächenträgheitsmomentIxx= double.Parse(ixx.Text),
        //     FlächenträgheitsmomentIyy = double.Parse(iyy.Text), Breite = double.Parse(breite.Text), Höhe= double.Parse(höhe.Text)
        //     });
